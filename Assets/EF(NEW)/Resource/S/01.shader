...
Shader "Shader Forge/01" {
    Properties {
        ...
        _node_7839 ("node_7839", Color) = (1,1,1,1)
...
////// Emissive:
                ...
                float3 emissive = ((_node_7595.rgb*pow(node_2181,_Rim_pow))+(_MainTex_var.rgb*i.vertexColor.rgb*_TintColor.rgb*_node_7688*_MainTex_2_var.rgb)+(_node_7839.rgb*pow((1.0 - node_2181),_Rim_pow2)));
